...
const mockCardSeeds = [
  ...
  { category: 'PerceivedAge', evaluationType: 'NUMERIC_AGE', author: 'pool_jiyeon', question: '사람들은 저를\n몇 살로 볼까요?', subtext: 'How old do I look at first glance?', imageUrls: perceivedAgeAlbums.pool, ageMin: 25, ageMax: 42, ageEstimate: 32.4, ageVoteCount: 28, comments: [{ id: 'age-c1', author: 'summer_note', body: '수영장에서도 생기 있는 첫인상이에요.', createdAt: '9분 전', replies: [] }] },
  { category: 'PerceivedAge', evaluationType: 'NUMERIC_AGE', author: 'cycle_mina', question: '자전거 라이딩 후의 저는\n몇 살로 보여요?', subtext: 'What age does this active look suggest?', imageUrls: perceivedAgeAlbums.bike, ageMin: 26, ageMax: 44, ageEstimate: 34.1, ageVoteCount: 41, comments: [{ id: 'age-c2', author: 'ride_seoul', body: '건강하고 밝은 에너지가 느껴져요.', createdAt: '14분 전', replies: [] }] },
  { category: 'PerceivedAge', evaluationType: 'NUMERIC_AGE', author: 'career_yuna', question: '일하다 잠깐 찍은 이 사진,\n몇 살로 보여요?', subtext: 'How old do I look in this workday moment?', imageUrls: perceivedAgeAlbums.office, ageMin: 27, ageMax: 46, ageEstimate: 33.2, ageVoteCount: 53, comments: [{ id: 'age-c3', author: 'office_days', body: '차분하고 자신감 있는 분위기예요.', createdAt: '18분 전', replies: [] }] },
