...
export const initialCards = [
  ...
  { id: 'card-2', author: 'daily_look', category: 'Dating', question: '소개팅에서 이 첫인상을 보면\n호감이 생길 것 같나요?', subtext: 'Would you be interested after seeing this first impression on a blind date?', imageUrl: datingImage, objectPosition: 'center 38%', yesVotes: 942, noVotes: 88, timestamp: '30분 전', isMyUpload: true, commentsAllowed: true, comments: [{ id: 'c4', author: 'firstlook_kr', body: '밝은 색감이라 편안한 인상이네요.', createdAt: '12분 전', replies: [] }] },
